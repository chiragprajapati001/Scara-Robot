...
const long maxSteps = 600; // Maximum steps
const long minSteps = -600;   // Minimum steps

void setup() {
  // Set max speed and acceleration for the stepper motor
  stepper.setMaxSpeed(200);  // Max speed in steps per second
  stepper.setAcceleration(200); // Acceleration in steps per second^2
